...
function createMenuItems(nameValue, priceValue, categoryValue){
  const randomObj = {name: nameValue, price: priceValue, category: categoryValue}
  return randomObj
}
...
*/
reviews.push({name:"Norm", rating: 1, feedback:"This was probably the worst place that ive been to in a while"})
console.log(reviews);
